...
#banner
print ("===================================================")
print ("~Telegram Click bot~")
print ("AUTHOR: Eren Gans")
print ("Indonesia Security Lite")
print ("===================================================")
...
try:
    for ulang in range(999999999):
        ...
        sys.stdout.write('\r{}Sek Diluk'.format(yellow2))
        ...
        if message_history.messages[0].message.find('ENTEK') != -1:
            sys.stdout.write('\r                                                     \r')
            sys.stdout.write('\r{}Entek COK!1!1!1!\n'.format(red2))
            break
        url = message_history.messages[0].reply_markup.rows[0].buttons[0].url
        sys.stdout.write('\r                                                     \r')
        sys.stdout.write('\r{}Sek Enteni {}'.format(yellow2,putih)+url)
